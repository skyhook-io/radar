...
- **Private by design** — your resources, logs and events stay on your machine. No account, no agents, no cloud sync. Anonymous usage stats, including rough cluster size, only if you opt in ([what Radar sends](docs/configuration.md#what-radar-sends))
