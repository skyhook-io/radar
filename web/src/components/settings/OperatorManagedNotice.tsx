  ...
  return (
    <div className="flex items-start gap-2 rounded-lg border border-theme-border bg-theme-elevated/50 p-3 text-sm">
      ...
      <div className="min-w-0">
        <p className="font-medium text-theme-text-primary">Managed by your operator</p>
        <p className="mt-1 text-xs text-theme-text-secondary">
          To change these settings, ask your operator to update {helmValue ? <><code className="font-mono">{helmValue}</code> in </> : null}
          Radar’s Helm values or startup configuration.
