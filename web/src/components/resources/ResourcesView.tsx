...
export function ResourcesView({ namespaces, selectedResource, onResourceClick, onResourceClickYaml, onKindChange }: ResourcesViewProps) {
  ...
  const { data: countsData } = useQuery({
    ...
    staleTime: 10000,
    refetchInterval: 60000, // Safety net — SSE k8s_event drives real-time invalidation
  })
  ...
  const selectedKindQuery = useQuery({
    ...
    staleTime: 30000,
    refetchInterval: 120000, // Safety net — SSE k8s_event drives real-time invalidation
