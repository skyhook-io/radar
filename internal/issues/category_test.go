...
func TestClassify(t *testing.T) {
	cases := []struct {
		...
		{"cronjob sidecar reason beats embedded forbidden message", classifyInput{Source: SourceProblem, Kind: "CronJob", Reason: "SidecarBlocksJobCompletion", Message: `pods is forbidden: User "system:serviceaccount:ci:default" cannot list resource "pods"`}, issuesapi.CategoryCronJobFailed},
