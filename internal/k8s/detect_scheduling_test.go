...
func TestClassifyAdmissionFailure(t *testing.T) {
	cases := []struct {
		...
		{`Error creating: failed calling webhook "validate.example.com": no endpoints available for service "policy-webhook"`, "WebhookUnavailable", true},
		{`Error creating: failed calling webhook "validate.example.com": Post "https://other.hooks.svc:443/validate": no endpoints available for service "policy-webhook"`, "WebhookUnavailable", true},
		{`Error creating: failed calling webhook "validate.example.com": Post "https://other.hooks.svc:443/validate": service "policy-webhook" not found`, "WebhookUnavailable", true},
		{`Error creating: failed calling webhook "validate.example.com": Post "https://policy-webhook.external.example/validate": service "policy-webhook" not found`, "WebhookUnavailable", true},
		{`Error creating: failed calling webhook "validate.example.com": Post "https://policy-webhook.hooks.svc:443/validate": dial tcp: connection refused`, "WebhookUnavailable", true},
		...
		{`Internal error occurred: failed calling webhook "timeout.example.com": failed to call webhook: Post "https://outside.example/validate": context deadline exceeded`, "WebhookUnavailable", true},
		{`failed calling webhook "tls.example.com": failed to call webhook: Post "https://hook.ns.svc:443/": tls: failed to verify certificate: x509: certificate signed by unknown authority`, "WebhookUnavailable", true},
		{`failed calling webhook "eof.example.com": failed to call webhook: Post "https://outside.example/": EOF`, "WebhookUnavailable", true},
		{`admission webhook "policy.example.com" denied the request: failed calling webhook "quoted.example.com": connection refused`, "WebhookDenied", true},
		{`admission webhook "policy.example.com" denied the request: exceeded quota`, "WebhookDenied", true},
		{`failed calling webhook "": connection refused`, "", false},
		{`failed calling webhook "named.example.com":`, "", false},
		{`application says failed calling webhook "named.example.com": timeout`, "", false},
		{`failed calling webhook "call.example.com": admission webhook "inner.example.com" denied the request`, "WebhookUnavailable", true},
