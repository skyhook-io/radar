...
| Touching anything library consumers import | [packages/radar-app/](packages/radar-app/) — `@skyhook-io/radar-app` re-exports from `web/src/RadarApp.tsx` + runtime config + nav slots. Breaking the surface breaks all downstream consumers. |
